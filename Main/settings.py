"""
Django base settings for Notation project.
...
SECRET_KEY = 'django-insecure-3=01fn3emmyc@6ir@ml(bb(c-%#d-lj&e7g_skkb1)^0ib&7)o'
...
TEMPLATES = [
    {
        ...
        'DIRS': [ # The list of directories where django can search for templates
            BASE_DIR / 'Base/Templates',
            BASE_DIR / 'User/Templates',
            BASE_DIR / 'Contributor/Templates',
            BASE_DIR / 'Community/Templates',
            BASE_DIR / 'Merchandise/Templates',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
